...
If you want to learn more about this project, read the [wiki](https://github.com/Chik-Network/chia-blockchain/wiki), or check out the [green paper](https://www.chia.net/assets/ChiaGreenPaper.pdf).
