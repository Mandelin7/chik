...
@click.option("--testnet", is_flag=True, help="Configure this chik install to connect to the testnet")
...
def init_cmd(
    ...
    from chik.cmds.passphrase_funcs import initialize_passphrase
