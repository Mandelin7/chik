...
from chik.daemon.client import acquire_connection_to_daemon
from chik.util.errors import KeychainMaxUnlockAttempts
from chik.util.keychain import Keychain, supports_os_passphrase_storage
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other Chik processes will be able to access your keys without prompting for your passphrase."
            )
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("CHIK_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'chik passphrase set' or 'chik passphrase remove' to update or remove your passphrase")
        sys.exit(1)
