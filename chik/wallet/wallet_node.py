...
from chik.protocols.wallet_protocol import CoinState, RespondBlockHeader, RespondToCoinUpdates
    ...
    def initialize_wallet_peers(self) -> None:
        ...
        if self.wallet_peers is None and connect_to_unknown_peers and not testing:
            self.wallet_peers = WalletPeers(
                ...
                self.config.get("dns_servers", ["dns-introducer.chik-network.net"]),
