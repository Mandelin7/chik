...
def call_plotters(root_path: Path, args):
    ...
    deprecation_warning = (
        "[DEPRECATED] 'chik plotters install' is no longer available. Use install-plotter.sh/ps1 instead."
    )
    subparsers.add_parser("install", help=deprecation_warning, add_help=False)

    deprecation_warning_bb2 = "[DEPRECATED] 'chik plotters bladebit2' was integrated to 'chik plotters bladebit'"
